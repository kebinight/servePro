...
Request::addDetector('iphone', ['env' => 'HTTP_USER_AGENT', 'pattern' => '/iphone/i']);
Request::addDetector('ios', ['env' => 'HTTP_USER_AGENT', 'pattern' => '/ios/i']);
Request::addDetector('android', ['env' => 'HTTP_USER_AGENT', 'pattern' => '/android/i']);
...
require_once dirname(__FILE__) . '/gcode.php';  //引入全局函数文件